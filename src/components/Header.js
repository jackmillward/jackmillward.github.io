                                            ...
                                            {menuItem.path ? (
                                                ...
                                                <>
                                                    <a
                                                        ...
                                                        className="flex cursor-pointer justify-items-end py-2 text-base text-dark group-hover:opacity-70 dark:text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0"
                                                    >
                                                        {menuItem.title}
                                                        <span className="pl-3">
